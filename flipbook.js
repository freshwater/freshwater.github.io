...
/*
 *
 * feel free to steal/reuse this code
 *
 */

/*
 *
 *  TODO improve handling of nested flipbook selection
 *    -- button should only be active if its container's slide is also active
 *
 *  TODO it didn't occur to me originally, but ideally this control should
 *    be built from more fundamental toggle/switch/on-off view(s)
 *
 */
